...
class ForgetMeNotDataset(Dataset):
    ...
    def __init__(
        ...
        for c, t, num_tok in multi_concept:
            ...
            print("[target_snippet]", target_snippet)
            if t == "object":
        ...
        self.num_instance_images = len(self.instance_images_path) # 10
    ...
    def __getitem__(self, index):
        ...
        # print("[instance_prompt]", instance_prompt, " [target_tokens]", target_tokens)

        if not instance_image.mode == "RGB":
            instance_image = instance_image.convert("RGB")
        example["instance_prompt"] = "a group of young people standing next to each other, in style of kyoto animation, kyoto animation still, high quality anime movie still, kyoto animation, anime still film anime shikishi, slice of life anime, official anime artwork, anime!!!!!!!!!!!!!!!, official art, anime still image, promotional art, official anime still, today's featured anime still"
        ...
        # print(example["concept_positions"])    
...
def main(args):
    ...
    class AttnController:
        ...
        def __call__(self, attn_prob, m_name) -> Any:
            ...
            # print("[target_attns]", target_attns.shape)
